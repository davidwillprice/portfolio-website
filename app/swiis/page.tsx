...
export default function SwiisDigital() {
  return (
    <>
      <div className={styles.intro_con}>
        ...
        <div className={styles.intro_text}>
          <p>
            ...
            <a href="https://www.swiis.com">Swiis International</a>, the parent
            company of{" "}
          ...
          <ul>
            <li>
              Using{" "}
              <span className="styles.highlight">HTML, CSS and JavaScript</span>{" "}
      ...
      <p>
        Previously, collecting feedback for these sessions would involve handing
        out sheets for carers to fillout, collecting them back, then sending
        them to the training team who would then manually input the results into
