  ...
  return (
    <>
      <div className={styles.intro_con}>
        <div className={styles.logo_con} style={{ backgroundColor: "#2e2e2e" }}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 114.724 50.508">
            <g
              id="Group_378"
              data-name="Group 378"
        ...
        <div className={styles.intro_text}>
          <p>
            ...
            <span className="styles.highlight">Thought & Mortar</span> from June
            2024 until its closure in March 2026.
          </p>
          <p>My duties included:</p>
          <ul>
            <li>
              Developing custom solutions to meet the needs of a wide variety of
              clients through bespoke theme features;
            </li>
            <li>
      ...
      <ul className={styles.intro_textContin}>
        ...
        <li>
          ...
          <span className="styles.highlight">Google Scripts</span> to manipulate
