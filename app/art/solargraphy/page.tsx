    ...
    <>
      ...
      <StandardCentralText>
        ...
        <p>
          ...
          started to eat the photographic paper&apos;s gelatine, causing the
      ...
      <StandardCentralText>
        ...
        <p>
          &quot;Image 62&quot; is one such Solargraph that features both insect
          activity and fingerprints. The camera was pointed towards the
      ...
      <StandardCentralText>
        <p>
          ...
          As the camera stayed very still during its exposure, there is a large
          amount of detail present including the village church on the horizon.
        </p>
        <p>
      ...
      <div className={solarStyles.dual_images}>
        ...
        <div>
          <Morph>
            ...
            />
            <Image src={image28Zoom} alt="Cropped Solargraph of Aberystwyth" />
          </Morph>
        </div>
      </div>
      <StandardCentralText>
      ...
      <StandardCentralText>
        <p>
          &quot;Image 73&quot; boasts one of the highest levels of detail in any
          of my solargraphs.
        </p>
        <p>
