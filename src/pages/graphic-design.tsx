...
export default function GraphicDesign({
  ...
  data: {
    teslaNowIcon: { childImageSharp: { gatsbyImageData: IGatsbyImageData } }
    aberLogo: { childImageSharp: { gatsbyImageData: IGatsbyImageData } }
    springholmLogo: { childImageSharp: { gatsbyImageData: IGatsbyImageData } }
  }
}) {
