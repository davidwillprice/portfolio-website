    ...
    return (
        <Layout>
            ...
            <div className={AberStyles.beInspiredCon}>
                <img src={AberInspiredWelsh} alt="Aberystwyth University 'Be Inspired' Welsh logo" />
                <img src={AberInspired} alt="Aberystwyth University 'Be Inspired' English logo" />
            </div>
            <StandardCentralText headerText="Be Inspired">
                <p>As a Welsh university, every design I created had to have a Welsh and English version, with the Welsh version featuring first.</p>
                <p>Catering for both languages was particularly difficult for the above project, where I designed a logo for a department wide competition called 'Be Inspired'.</p>
            </StandardCentralText>
            <div className={AberStyles.stepForwardCon}>
                <img src={StepForwardWelsh} alt="Aberystwyth University 'Step Forward' Welsh poster" />
                <img src={StepForward} alt="Aberystwyth University 'Step Forward' English poster" />
            </div>
            <StandardCentralText headerText="Step Foward">
                <p>The above posters were created for an ILLCA careers event called 'Step Forward'.</p>
                <p>If I were to redo the task, I would try removing the box pattern as currently the design feels too busy and I'd prefer more attention be brought to the text.</p>
            </StandardCentralText>
        </Layout >
    );
}