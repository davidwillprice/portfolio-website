...
export default function Solargraphy({
  ...
  data: {
    image8: { childImageSharp: { gatsbyImageData: IGatsbyImageData } }
    image8NoStreaks: { childImageSharp: { gatsbyImageData: IGatsbyImageData } }
    image17: { childImageSharp: { gatsbyImageData: IGatsbyImageData } }
    image28Zoom: { childImageSharp: { gatsbyImageData: IGatsbyImageData } }
    image28ZoomView: { childImageSharp: { gatsbyImageData: IGatsbyImageData } }
    image34: { childImageSharp: { gatsbyImageData: IGatsbyImageData } }
    image35: { childImageSharp: { gatsbyImageData: IGatsbyImageData } }
    image36: { childImageSharp: { gatsbyImageData: IGatsbyImageData } }
    image44: { childImageSharp: { gatsbyImageData: IGatsbyImageData } }
    image50: { childImageSharp: { gatsbyImageData: IGatsbyImageData } }
    image50Inverted: { childImageSharp: { gatsbyImageData: IGatsbyImageData } }
    image62: { childImageSharp: { gatsbyImageData: IGatsbyImageData } }
    image73: { childImageSharp: { gatsbyImageData: IGatsbyImageData } }
  }
}) {
