...
import LypPropSearchDesktopImg from '../images/lyp-property-search-desktop.png';
...
export default function WebDev() {
	return (
		<Layout>
			...
			<SqBrushSplash brush={<BrushTwo />} img={BmaHpMobImg} imgAlt="Bristol Marketing Agency homepage on mobile">
