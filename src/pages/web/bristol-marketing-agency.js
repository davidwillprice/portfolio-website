...
export default function bristolAgency() {
    return (
        <Layout>
            <SEO title="Bristol marketing agency" description="As part of a job application, I was tasked with redesigning the website of a Bristol based marketing agency" />
