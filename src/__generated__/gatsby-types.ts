...
type SEOQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<(
      ...
      & { defaultTitle: SiteSiteMetadata['title'], defaultDescription: SiteSiteMetadata['description'], siteUrl: SiteSiteMetadata['url'], defaultImage: SiteSiteMetadata['image'] }
    )> }> };

type pageFKeyFilesWebsiteportfolioWebsitesrcpagesartTsx3913544382QueryVariables = Exact<{ [key: string]: never; }>;


type pageFKeyFilesWebsiteportfolioWebsitesrcpagesartTsx3913544382Query = { readonly file: Maybe<{ readonly childImageSharp: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }> };

type pageFKeyFilesWebsiteportfolioWebsitesrcpagesgraphicDesignTsx1430367362QueryVariables = Exact<{ [key: string]: never; }>;


type pageFKeyFilesWebsiteportfolioWebsitesrcpagesgraphicDesignTsx1430367362Query = { readonly teslaNowIcon: Maybe<{ readonly childImageSharp: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }>, readonly aberLogo: Maybe<{ readonly childImageSharp: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }>, readonly springholmLogo: Maybe<{ readonly childImageSharp: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }> };
...
type pageFKeyFilesWebsiteportfolioWebsitesrcpagesgraphicDesignteslanowTsx1051186640QueryVariables = Exact<{ [key: string]: never; }>;


type pageFKeyFilesWebsiteportfolioWebsitesrcpagesgraphicDesignteslanowTsx1051186640Query = { readonly icons: Maybe<{ readonly childImageSharp: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }> };
...
type pageFKeyFilesWebsiteportfolioWebsitesrcpagesloveyourpostcodeTsx1705027987QueryVariables = Exact<{ [key: string]: never; }>;


type pageFKeyFilesWebsiteportfolioWebsitesrcpagesloveyourpostcodeTsx1705027987Query = { readonly factsTab: Maybe<{ readonly childImageSharp: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }> };
