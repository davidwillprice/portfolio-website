...
import brushPreviewStyles from '../styles/brushpreview.module.css';
...
export default function Home() {
	return (
		<Layout>
			...
			<div className={globalStyles.workExampleCon}>
				<div className={globalStyles.workExampleText}>
					<h3 className={globalStyles.workExampleHeader}>Bristol Marketing Agency</h3>
					<p>Feb 2018</p>
					<p>
						Website redesign over a weekend as part of the job application process for a Bristol based
						marketing agency.
					</p>
				</div>
