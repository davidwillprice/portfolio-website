...
const ContactIcons = ({ mobileOnly }: { mobileOnly?: boolean }) => (
  <div className={`${styles.links} ${mobileOnly ? styles.mobile_only : ""}`}>
    <a
    ...
    <a aria-label="Email David Price" href="mailto: davidwillprice@gmail.com">
      <svg
        viewBox="0 0 24 18"
        xmlns="http://www.w3.org/2000/svg"
